    ...
    <>
        <div className="w-full flex justify-between mb-10">
                ...
                <div className="relative flex items-center pr-10">
                    <div className={`absolute ${menu?'visible':'hidden'} w-40 h-10 bg-zinc-200 border hover:bg-white  border-zinc-400 rounded mt-20 -ml-14 text-lg flex items-center justify-center`} onClick={logout}>
                        <h1>Logout</h1>
                    </div>
                    <FaUser className="ml-4 text-2xl hover:text-gray-800 text-gray-700" onClick={()=>setMenu(!menu)}/>
