...
const UploadTypeComponents = ({ uploadFile }) => {
  return (
    <div className="w-full lg:w-11/12 h-2/5 lg:h-1/5 flex flex-col lg:flex-row mb-14 lg:mb-0">
      <div
        className="w-full lg:w-1/3 h-24 lg:h-[120px] rounded-lg border shadow-lg mr-4 border-gray-400 flex items-center p-4"
      ...
      <div
        className="w-full lg:w-1/3 h-24 lg:h-[120px] rounded-lg border shadow-lg border-gray-400 flex items-center p-4"
