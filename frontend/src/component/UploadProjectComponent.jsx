...
const UploadProjectComponent = ({setOpen,uploadType,logo,projectId,setSubProjects}) => {
  ...
  return (
    <div className='absolute w-full h-full bg-black z-10 bg-opacity-40 flex justify-center items-center'>
        <div className='w-3/5 h-1/2 p-6 rounded-lg shadow-xl bg-white px-8 '>
            ...
            <div className='mt-6 w-full flex justify-end'>
                <button className='ml-6 w-2/12 duration-200 font-semibold text-white h-10 rounded bg-[rgb(33,25,53)] hover:bg-[rgb(54,41,86)] ' onClick={handleCreate}>Save</button>
            </div>
        </div>
    </div>
  )
