    ...
    <div className='w-full max-h-[500px] overflow-auto p-3 flex flex-col myscroll pb-10'>
        <div className='w-full h-2/3 flex flex-nowrap flex-col lg:flex-row lg:flex-wrap'>
            <div className='w-full lg:w-1/2 mt-2'>
                ...
                <div className='flex'>
                    <input className='w-4/5 h-10 mr-2 rounded-md border-1 outline-1 bg-slate-300 focus:outline-none px-3 text-zinc-500 font-medium' type="text" value={configData.primarycolor} disabled/>
                    <input
            ...
            <div className='w-full lg:w-1/2 mt-2'>
                ...
                <div className='flex'>
                    <input className='w-4/5 h-10 mr-2 rounded-md border-1 outline-1 bg-slate-300 focus:outline-none px-3 text-zinc-500 font-medium' value={configData.fontcolor} type="text" disabled/>
                    <input
                    className={`w-10 h-10 border-transparent rounded-md`}
                    type="color"
            ...
            <div className='w-full lg:w-1/2 mt-4'>
                ...
                <div className='flex pr-0 lg:pr-10'>
                    <input className='w-full h-10 mr-2 rounded-md border-1 outline-1 bg-slate-300 focus:outline-none px-3' type="number" placeholder={configData.fontsize} onChange={(e)=>handleFontSize(e.target.value)}/>
                </div>
                {error.fontsize&&<h1 className='text-[10px] mt-1 text-red-600 mb-2'>Lorem ipsuim dolor sit Lorem ipsuim dolor sit</h1>}
            </div>
            <div className='w-full lg:w-1/2 mt-4'>
                <h1 className='text-xl font-bold text-zinc-700 mb-2'>Chat Height (in % of total screen)</h1>
                <div className='flex pr-0 lg:pr-10'>
                    <input className='w-full h-10 mr-2 rounded-md border-1 outline-1 bg-slate-300 focus:outline-none px-3' type="number" placeholder={configData.chatheight} onChange={(e)=>handleChatHeight(e.target.value)}/>
                </div>
                {error.chatheight&&<h1 className='text-[10px] mt-1 text-red-600 mb-2'>Lorem ipsuim dolor sit Lorem ipsuim dolor sit</h1>}
            </div>
        </div>
        ...
        <div className='w-full '>
            ...
            <div className='w-full lg:w-1/2'>
                ...
                <div className='flex pr-0 lg:pr-10'>
                    <select
                        ...
                        onChange={(e)=>{handleChatIconSize(e.target.value)}}
                        >
            ...
            <div className='w-full lg:w-1/2'>
                ...
                <div className='flex pr-0 lg:pr-10'>
                    <select
                        ...
                        onChange={(e)=>{handleScreenPos(e.target.value)}}
                        >
            ...
            <div className='w-full lg:w-1/2 mt-3'>
                <h1 className='text-xl font-bold text-zinc-700 mb-2 mt-2'>Distance from Bottom (in px)</h1>
                <div className='flex pr-0 lg:pr-10'>
                    <input className='w-full h-10 mr-2 rounded-md border-1 outline-1 bg-slate-300 focus:outline-none px-3' type="number" placeholder={configData.distanceBottom} onChange={(e)=>handleBottomDist(e.target.value)}/>
                </div>
                {error.distanceBottom&&<h1 className='text-[10px] mt-1 text-red-600 mb-2'>Lorem ipsuim dolor sit Lorem ipsuim dolor sit</h1>}
            </div>
            <div className='w-full lg:w-1/2 mt-3'>
                <h1 className='text-xl font-bold text-zinc-700 mb-2 mt-2'>Horizontal Distance (in px)</h1>
                <div className='flex pr-0 lg:pr-10'>
                    <input className='w-full h-10 mr-2 rounded-md border-1 outline-1 bg-slate-300 focus:outline-none px-3' type="number" placeholder={configData.distanceHorizontal} onChange={(e)=>handleHorizontalDist(e.target.value)}/>
                </div>
                {error.distanceHorizontal&&<h1 className='text-[10px] mt-1 text-red-600 mb-2'>Lorem ipsuim dolor sit Lorem ipsuim dolor sit</h1>}
            </div>
        </div>
            ...
            <div className='w-full flex items-center'>
                ...
                <div className='flex w-1/2 flex-col justify-center pt-4'>
                    ...
                    {error.image&&<h1 className='text-[10px] text-red-600'>file must be in jpg/jpeg/png format</h1>}
                </div>
            </div>
        </div>
    </div>
