      ...
      {projects.length>0?(
            <div className='w-full flex flex-wrap pl-10 lg:pl-32 mt-10'>
                <div className='w-11/12 h-30 flex flex-row justify-between pr-16 pl-2 items-center mb-6'>
                    ...
                    <button className="capitalise w-1/6 h-[40px] p-1 rounded-md text-white font-bold bg-[rgb(33,25,53)] capitalize hover:bg-[rgb(54,41,86)] flex justify-center items-center" onClick={handleCreateProject}><IoIosAddCircle className='text-2xl font-bold' /><span className='ml-2'>create new project</span></button>
                </div>
                {projects?.map(data=>{
