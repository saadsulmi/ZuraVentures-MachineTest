    ...
    <div className="w-full h-[100vh] flex flex-row">
      ...
      <div className="w-full lg:w-9/12 h-[100vh] text-black px-10 pt-10 ">
        ...
        {subProjects.length > 0 ? (
          ...
          <>
            <div className="w-11/12 flex flex-col pb-2 items-center my-10">
            ...
            <div className="w-11/12 h-2/6 flex flex-col items-center border-2 border-dashed rounded-xl border-gray-400 justify-center">
              ...
              <h1 className="text-[rgb(73,69,79)]">
                Select a file or drag and drop here (Podcast Media or
                Transcription Text)
              </h1>
              <h1 className="text-[rgb(153,153,153)]">
                MP4, MOV, MP3, WAV, PDF, DOCX or TXT file
              </h1>
              <button className="w-1/6 rounded-full p-2 mt-5 border-2 text-blue-800 border-blue-800">
                Save file
              </button>
            </div>
          </>
